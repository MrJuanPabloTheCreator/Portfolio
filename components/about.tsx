...
export const About = () => {
  ...
  return (
    <section 
      id="about"
      // ref={ref}
      className="flex flex-col items-center w-full py-24 bg-white/10 backdrop-blur-[24] scroll-mt-28 z-10 md:about-section" 
    >
      <h2 className="font-extrabold text-white text-center mb-5 text-5xl md:about-t">
        About me
      </h2>
      <p className="font-medium text-md md:text-2xl text-center mx-5 md:w-[1100px] text-slate-300 md:about-t">
